CREATE DATABASE  IF NOT EXISTS `findmydoctor` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `findmydoctor`;
...
CREATE TABLE `doctor` (
  ...
  `Docpic` blob,
  `HName` varchar(95) DEFAULT NULL,
  `CName` varchar(95) DEFAULT NULL,
  PRIMARY KEY (`docId`),
...
INSERT INTO `doctor` VALUES (1001,'james cook',36,'M','dentist',NULL,'aurthur street East',60,NULL,'Thunderbay Regional hospital',NULL),(1002,'stephen black',45,'M','dentist',NULL,'Balmoral street',65,NULL,'Thunderbay Regional hospital',NULL),(1003,'jack williams',55,'M','dentist',NULL,'Baker Avenue',50,NULL,'','Red River Walk-In Medical Clinic'),(1004,'rose turner',33,'F','dentist',NULL,'Beverly Street',55,NULL,'thunderbay pioneer ridge',NULL),(1005,'mi chang',40,'F','dentist',NULL,'Lacewood Drive',50,NULL,'thunderbay pioneer ridge',NULL),(1006,'shane watson',55,'M','Neurologist',NULL,'jon street',60,NULL,'Lakehead Psychiatric Hospital',NULL),(1007,'sheela kumar',32,'F','gynecologist',NULL,'machar street',100,NULL,'Thunderbay Regional hospital',NULL),(1008,'adam jhonson',44,'M','gynecologist',NULL,'helen street',90,NULL,'Thunderbay Regional hospital',NULL),(1009,'cody rhodes',60,'M','gynecologist',NULL,'graham road',95,NULL,'St. Joseph\'s Hospital',NULL),(1010,'jeremy wallop',36,'M','gynecologist',NULL,'madison street',80,NULL,NULL,'Thunder Bay Regional Health Sciences Centre-Fracture Clinic'),(1011,'lilly smurf',55,'F','gynecologist',NULL,'manitou street',85,NULL,NULL,'Good Doctors Thunder Bay'),(1012,'harjith singh',42,'M','Neurologist',NULL,'maple avenue',90,NULL,'Lakehead Psychiatric Hospital',NULL),(1013,'jhonny bravo',39,'M','pediatrician',NULL,'edward street',100,NULL,'Thunderbay Regional hospital',NULL),(1014,'adam smith',66,'M','pediatrician',NULL,'sunrise boulevard',110,NULL,NULL,'Good Doctors Thunder Bay'),(1015,'mary smith',62,'F','pediatrician',NULL,'sherrington drive',120,NULL,'thunderbay pioneer ridge',NULL),(1016,'jeffery taylor',44,'M','pediatrician',NULL,'golf links road',110,NULL,'Thunderbay Regional hospital',NULL),(1017,'Michael Jackson',43,'M','pediatrician',NULL,'oliver street',115,NULL,NULL,'Good Doctors Thunder Bay'),(1018,'jennifer miller',39,'F','Neurologist',NULL,'oliver street',100,NULL,'Lakehead Psychiatric Hospital',NULL),(1019,'olivia brown',46,'F','orthopedist',NULL,'central avenue',80,NULL,'thunderbay pioneer ridge',NULL),(1020,'Ava stachanowska',49,'F','orthopedist',NULL,'winnipeg avenue',85,NULL,NULL,'Port Arthur Health Centre'),(1021,'jemma stones',33,'F','orthopedist',NULL,'fort william road',85,NULL,'St. Joseph\'s Hospital',NULL),(1022,'roger moore',55,'M','orthopedist',NULL,'bay street',90,NULL,'Thunderbay Regional hospital',NULL),(1023,'wayne Thompson',43,'M','orthopedist',NULL,'memorial street',85,NULL,NULL,'Port Arthur Health Centre'),(1024,'william harris',42,'M','Neurologist',NULL,'court street',80,NULL,NULL,'Thunder Bay Regional Health Sciences Centre-Fracture Clinic'),(1025,'Stephen walker',44,'M','dermatologist',NULL,'waterfront',70,NULL,'thunderbay pioneer ridge',NULL),(1026,'isabella young',46,'F','dermatologist',NULL,'rockwood street',65,NULL,'Thunderbay Regional hospital',NULL),(1027,'tong lee',55,'M','dermatologist',NULL,'red river road',65,NULL,NULL,'Thunder Bay Regional Health Sciences Centre-Fracture Clinic'),(1028,'praveen sharma',48,'M','dermatologist',NULL,'windsor road',60,NULL,'St. Joseph\'s Hospital',NULL),(1029,'rodolph kachum',44,'M','dermatologist',NULL,'carrik street',70,NULL,'Thunderbay Regional hospital',NULL),(1030,'ryan chuck',55,'M','Neurologist',NULL,'memorial street',75,NULL,'','Red River Walk-In Medical Clinic');
...
INSERT INTO `patients` VALUES (3001,'john snow','28','jsnow@gmail.com',8888888225,'m','123456'),(3002,'john cena','35','jcena@gmail.com',8888888202,'m','123456'),(3003,'vasista','21','vasista@gmail.com',8985897338,'m','123456');
...
-- Dump completed on 2018-03-23 18:41:09
